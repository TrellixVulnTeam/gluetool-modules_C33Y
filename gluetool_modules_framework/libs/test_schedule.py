...
GuestSetupOutputsContainerType = Dict[
    gluetool_modules_framework.libs.guest_setup.GuestSetupStage,
    List[gluetool_modules_framework.libs.guest_setup.GuestSetupOutput]
]
...
class InvalidTmtReferenceError(
            ...
            for se in self:
                for stage in STAGES_ORDERED:
                    ...
                    if stage == TestScheduleEntryStage.GUEST_SETUP:
                        for guest_setup_stage in gluetool_modules_framework.libs.guest_setup.STAGES_ORDERED:
