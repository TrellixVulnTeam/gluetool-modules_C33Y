...
from gluetool_modules_framework.libs import ANY, GlueEnum
...
AvailableArchesType = Union[gluetool_modules_framework.libs._UniqObject, List[str]]
...
class NoTestableArtifactsError(gluetool_modules_framework.libs.sentry.ArtifactFingerprintsMixin, SoftGlueError):
    """
    ...
    *Testing constraints patching*
    ...
    def execute(self):
        ...
        if not artifact_arches:
            if supported_arches is gluetool_modules_framework.libs.ANY:
