...
class TestScheduleTMT(Module):
    ...
    def serialize_test_schedule_entry_results(self, schedule_entry, test_suite):
        ...
        for task in schedule_entry.results:
            ...
            assert schedule_entry.guest.environment.arch is not None
            assert schedule_entry.guest.environment.compose is not None
            assert schedule_entry.testing_environment is not None
            assert schedule_entry.provisioned_environment is not None
            _add_property(properties, 'arch', cast(str, schedule_entry.guest.environment.arch))
            ...
            _add_property(properties, 'guest-compose', cast(str, schedule_entry.guest.environment.compose))
